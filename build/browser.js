...
(function (exports) {
    ...
    async function fetchGZip(url, parameter) {
        return fetch(url, parameter)
            .then(response => response.blob())
            .then(data => new Response(data.stream().pipeThrough(new DecompressionStream('gzip'))));
    }
    ...
    exports["default"] = joFetch;
    exports.fetchAutoRetry = fetchAutoRetry;
    exports.fetchBlob = fetchBlob;
    exports.fetchDocument = fetchDocument;
    exports.fetchGZip = fetchGZip;
    exports.fetchInTime = fetchInTime;
    exports.fetchJSON = fetchJSON;
    exports.fetchOnlyResponseOk = fetchOnlyResponseOk;
    exports.fetchText = fetchText;

    Object.defineProperty(exports, '__esModule', { value: true });

})(this["jo-fetch"] = this["jo-fetch"] || {});
